 ...
 */
unsigned int sysctl_sched_latency			= 900000ULL;
unsigned int normalized_sysctl_sched_latency		= 900000ULL;
 ...
 */
unsigned int sysctl_sched_wakeup_granularity		= 900000UL;
unsigned int normalized_sysctl_sched_wakeup_granularity	= 900000UL;
 ...
 */
unsigned int sysctl_sched_cfs_bandwidth_slice		= 900000UL;
#endif
...
static const u8 degrade_zero_ticks[CPU_LOAD_IDX_MAX] = {0, 8, 32, 64, 128, 256, 512, 1024};
...
static int select_idle_cpu(struct task_struct *p, struct sched_domain *sd, int target)
{
	 ...
	 */
	avg_idle = this_rq()->avg_idle / 1024;
