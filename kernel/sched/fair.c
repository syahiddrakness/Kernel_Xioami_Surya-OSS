 ...
 */
unsigned int sysctl_sched_wakeup_granularity		= 500UL;
unsigned int normalized_sysctl_sched_wakeup_granularity	= 500UL;

const_debug unsigned int sysctl_sched_migration_cost	= 500UL;
...
unsigned int sysctl_sched_min_task_util_for_colocation = 900;
#endif
