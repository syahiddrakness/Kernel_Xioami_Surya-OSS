 ...
 * fixed_power_int())
 *
 * The calculation is approximated on a 2048 point scale.
 */
#define DEGRADE_SHIFT		7

static const u8 degrade_zero_ticks[CPU_LOAD_IDX_MAX] = {0, 8, 32, 64, 128, 256, 512, 1024, 2048};
