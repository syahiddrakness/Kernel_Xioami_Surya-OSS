...
module_param_named(adreno_idler_idleworkload, idleworkload, ulong, 0644);
...
module_param_named(adreno_idler_idlewait, idlewait, uint, 0644);

/* Taken from ondemand */
static unsigned int downdifferential = 20;
module_param_named(adreno_idler_downdifferential, downdifferential, uint, 0644);

/* Master switch to activate the whole routine */
static bool adreno_idler_active = false;
module_param_named(adreno_idler_active, adreno_idler_active, bool, 0644);
