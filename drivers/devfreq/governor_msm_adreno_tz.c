...
/*
 * FLOOR is 120 msec to capture up to 3 re-draws
 * per frame for 60fps content.
 */
#define FLOOR		        120000
/*
 * MIN_BUSY is 120 msec for the sample to be sent
 */
#define MIN_BUSY		120000
#define MAX_TZ_VERSION		0

/*
 * CEILING is 120 msec, larger than any standard
