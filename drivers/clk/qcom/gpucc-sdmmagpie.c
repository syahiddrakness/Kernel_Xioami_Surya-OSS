...
enum vdd_gx_levels {
	VDD_GX_NONE,
	VDD_GX_RETENTION,	/* RETENTION */
	VDD_GX_MIN,		/* MIN SVS */
	VDD_GX_LOWER,		/* SVS2 */
	VDD_GX_LOW,		/* SVS */
	VDD_GX_LOW_L1,		/* SVS_L1 */
	VDD_GX_LOW_L2,		/* SVS_L2 */
	VDD_GX_NOMINAL,		/* NOM */
	VDD_GX_NOMINAL_L1,	/* NOM_L1 */
	VDD_GX_NOMINAL_L2,	/* NOM_L2 */
	VDD_GX_HIGH,		/* TURBO */
	VDD_GX_HIGH_L1,		/* TURBO_L1 */
	VDD_GX_NUM,
};

static int vdd_gx_corner[] = {
	RPMH_REGULATOR_LEVEL_OFF,		/* VDD_GX_NONE */
	RPMH_REGULATOR_LEVEL_RETENTION,		/* VDD_GX_RETENTION */
	...
	RPMH_REGULATOR_LEVEL_NOM_L2,		/* VDD_GX_NOMINAL_L2 */
...
static const struct freq_tbl ftbl_gpu_cc_gx_gfx3d_clk_src[] = {
	...
	F(500000000, P_CRC_DIV, 1, 0, 0),
	F(534000000, P_CRC_DIV, 1, 0, 0),
	F(550000000, P_CRC_DIV, 1, 0, 0),
...
static struct clk_rcg2 gpu_cc_gx_gfx3d_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.rate_max = (unsigned long[VDD_GX_NUM]) {
			[VDD_GX_RETENTION] = 150000000,
			[VDD_GX_MIN] = 250000000,
			[VDD_GX_LOWER] = 350000000,
			[VDD_GX_LOW] = 450000000,
			[VDD_GX_LOW_L1] = 550000000,
			[VDD_GX_LOW_L2] = 650000000,
			[VDD_GX_NOMINAL] = 750000000,
